        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dx < 0) {//向左滑动
                    ...
                    mContent.setBackgroundColor(getContext().getResources().getColor(R.color.white));
                } else {

                    //Log.e("eeeeee偏移量 向右滑动：", dx + " ");
                    //向右滑动
                ...
                Log.e("eeeeee", "点击位置：" + mLastX + "  不可滑动位置:" + mMenuWidth + "~" + mScreenWidth);
            ...
            case MotionEvent.ACTION_UP:
                if (getScrollX() < -mMenuWidth / 2) {//打开Menu
                    ...
                    invalidate();
                    mContent.setBackgroundColor(getContext().getResources().getColor(R.color.drawer_background));
