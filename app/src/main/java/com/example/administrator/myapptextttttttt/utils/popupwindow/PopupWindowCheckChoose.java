...
public class PopupWindowCheckChoose extends PopupWindow {
    ...
    public void initView() {
        ...
        mTvTag = (TextView) mView.findViewById(R.id.tv_tag);
        mListView = (ListView) mView.findViewById(R.id.lv_list);
        mTvButtom = (TextView) mView.findViewById(R.id.tv_buttom);
    ...
    public void initLisenter() {
        ...
        mTvButtom.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class CheckAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.ctvContent = (CheckedTextView) convertView.findViewById(R.id.ctv_content);
