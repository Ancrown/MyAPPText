package com.example.administrator.myapptextttttttt.dialog;
...
import com.example.administrator.myapptextttttttt.views.SizeUtils;
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    public void startLoading() {
        ...
        startY = (int) (height + SizeUtils.dip2px(getContext(), 60)) / 2;
