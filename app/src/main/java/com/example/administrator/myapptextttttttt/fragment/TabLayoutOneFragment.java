package com.example.administrator.myapptextttttttt.fragment;
...
public class TabLayoutOneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bView = (BroadcastView) view.findViewById(R.id.bro);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        imageResIds.add("http://pic1.win4000.com/pic/7/56/88911163927.jpg");
